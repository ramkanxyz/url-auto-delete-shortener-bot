...
API_ID = int(environ.get('20489101', ''))
API_HASH = environ.get('0c673488548bbb408aab0785ec7879f1', '')
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('-1002073646130', '0').split()]
...
# Others
LOG_CHANNEL = int(environ.get('-1002194999754', ''))
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('-1002073646130', '')).split()]
...
URL_SHORTNER_WEBSITE_API = environ.get('890c4813697f994a54ce9b821ef3a35ba0e9eeaf', '')
